...
<div x-data="{ show: @entangle($attributes->wire('model')) }" x-on:close.stop="show = false" x-on:keydown.escape.window="show = false" x-show="show"
    ...
    <div x-show="show"
        class="p-[3px] bg-gradient-to-r from-sky-500 via-blue-500 to-indigo-500 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
